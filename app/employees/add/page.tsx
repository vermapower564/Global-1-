...
export default function AddEmployeePage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto pb-12 font-sans">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            Create an internal employee account. A valid @gmail.com address and Employee ID are required.
          </p>
        </div>
      ...
      {errorMsg && (
        <div className="p-4 rounded-xl bg-rose-50 border border-rose-200 text-rose-700 text-xs font-bold shadow-xs animate-in fade-in">
          ⚠️ {errorMsg}
        </div>
      )}

      {statusMsg && !errorMsg && (
        <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-blue-800 text-xs font-bold shadow-xs animate-in fade-in">
          {statusMsg}
        </div>
      )}
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Gmail Address (@gmail.com) *</label>
              <input
                type="email"
                required
          ...
          <div className="pt-4 flex items-center justify-end gap-3 border-t border-slate-200 dark:border-slate-800">
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-xs px-6 py-2.5 rounded-xl shadow-md flex items-center gap-2 transition cursor-pointer"
            >
